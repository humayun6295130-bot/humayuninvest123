...
import { DollarSign, LayoutDashboard, Settings, Briefcase, Wallet, Newspaper } from "lucide-react";
      ...
      <Sidebar collapsible="icon" className="border-r border-sidebar-border">
        ...
        <SidebarContent>
          <SidebarMenu>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton asChild isActive={pathname.startsWith('/wallet')} tooltip="Wallet">
                <Link href="/wallet">
                  <Wallet />
                  <span>Wallet</span>
                </Link>
             ...
             <SidebarMenuItem>
              <SidebarMenuButton asChild isActive={pathname.startsWith('/content')} tooltip="Content">
                <Link href="/content">
                  <Newspaper />
                  <span>Content</span>
                </Link>
