...
export default function PortfolioPage() {
  ...
  const totalValue = assets?.reduce((acc: number, a: any) => acc + (a.quantity * a.average_cost), 0) || 0;
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="border-dashed border-2 flex flex-col justify-center items-center text-center p-6 bg-muted/20 hover:bg-muted/30 transition-colors">
          ...
          <div className="text-xl font-bold text-primary mt-1">{userProfile?.active_plan || "No Plan"}</div>
